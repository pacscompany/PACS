...
<body>
    <div class="navbar-fixed" style="z-index: 999;">
        <nav class="orange" role="navigation">
            <div class="nav-wrapper container"><a id="logo-container" href="#" class="brand-logo" style="font-weight: 300">Game Play</a>
    ...
    <div id="modal1" class="modal" style="margin-top: 100px;">
        <div class="modal-content" style="padding-bottom: 0;">
            <h5 class="orange-text uppercase" style="font-size: 20px">The bottle is stolen..!!!</h5>
            <p style="text-align: justify">
            <?php echo $rr->clues; ?>    
            </p>
            <p class="light center-align" style="border-top: thin dashed #000;">
                Clue No: 
                <span><?php echo $gamelevel; ?></span>
            </p>
        </div>
        <div class="modal-footer">
            <a onclick="goto()" class="center-align modal-action modal-close waves-effect waves-green btn-flat" style="width: 100%">
                collect the clue and continue
            </a>
        </div>
    </div>
    <?php
    ...
    <script type="text/javascript">
        function goto(){
            window.location.href = '<?php echo BASE; ?>HomeController/load_bill';
        }
        ...
        $('#lock').click(function () {
            var msg = "<p>"
            Materialize.toast('Complete Game', 3000);
        });
        var count = 0;
        $("#count").text(count);
